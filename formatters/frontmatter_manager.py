    ...
    try:
        ...
        if closing_marker in markdown_content:
            ...
            try:
                ...
                print(f"Varning: Kunde inte sortera front matter efter att ha uppdaterat {property_name}: {e}")
        ...
        if closing_marker in markdown_content:
            ...
            if len(filtered_lines) != len(lines):
                ...
                try:
                    ...
                    print(f"Varning: Kunde inte sortera front matter efter att ha tagit bort {property_name}: {e}")
