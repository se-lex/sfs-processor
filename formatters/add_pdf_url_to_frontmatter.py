...
def generate_pdf_url(beteckning: str, utfardad_datum: str = None, check_exists: bool = True) -> str:
    ...
    try:
        ...
        if is_old_database:
            ...
            # YY ska vara de två sista siffrorna från året (t.ex. 98 för 1998) och
            # SEQNUMBER ska vara 4 siffror (04d)
            ...
            try:
                ...
                if isinstance(utfardad_datum, str):
                    if 'T' in utfardad_datum:
                        ...
                        pub_date = datetime.datetime.fromisoformat(
                            utfardad_datum.replace('Z', '+00:00'))
                    else:
                ...
                print(
                    f"Kunde inte parsa utfardad_datum '{utfardad_datum}' för {beteckning}, hoppar över")
                return None

            # Nya databasen:
            # https://svenskforfattningssamling.se/sites/default/files/sfs/{PUBLISHED_YEAR}-{PUBLISHED_MONTH}/SFS{YEAR}-{SEQNUMBER}.pdf
