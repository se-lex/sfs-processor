...
def fetch_eur_lex_document_info(
        celex_number: str, language: str = "SV") -> Optional[Dict[str, Any]]:
    """
    ...
    try:
        ...
        # Om vi får 404 eller 400 och det är sektor 3 (lagstiftning), försök med
        # sektor 2 (rättspraxis)
...
def _create_document_info(celex_number: str, url: str, language: str,
