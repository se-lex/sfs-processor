...
def analyze_ikraft_overgangsbestammelse(json_dir):
    ...
    for json_file in json_path.glob('*.json'):
        ...
        try:
            ...
            # Check main document
            if data.get('ikraftOvergangsbestammelse') == True:
            ...
            if 'andringsforfattningar' in data:
                for andring in data['andringsforfattningar']:
                    if andring.get('ikraftOvergangsbestammelse') == True:
...
if __name__ == "__main__":
    ...
    print(f"Files with ikraftOvergangsbestammelse=true in main doc: {stats['files_with_ikraft_true']}")
    ...
    for example in stats['examples_no_datetime']:
        ...
        print(f"  ikraftDenDagenRegeringenBestammer: {example['ikraftDenDagenRegeringenBestammer']}")
        if 'type' in example:
