...
forarbeten: - "PROP 2021/22:131"
  - "BET 2021/22:JuU30"
  - "RSKR 2021/22:323"
pdf_url: https://svenskforfattningssamling.se/sites/default/files/sfs/2022-06/SFS2022-700.pdf
andringsforfattningar:
  - beteckning: "2024:331"
    rubrik: Lag om ändring i lagen om särskild kontroll av vissa utlänningar
  ...
  - beteckning: "2025:1294"
    rubrik: Lag om ändring i lagen om särskild kontroll av vissa utlänningar
    ikraft_datum: 2026-01-01
    anteckningar: ändr. 6 kap. 12 §
---
<article selex:utfardad_datum="2022-06-02" selex:ikraft_datum="2022-07-01">
...
<section id="kap1.tillämpliga-bestämmelser-i-ann">
...
<section id="kap1.skyndsam-handläggning">
...
<section id="kap1.proportionalitetsbedömning">
...
<section id="kap2.förutsättningar-för-att-beslut">
...
<section id="kap2.vem-som-får-ansöka-och-besluta">
...
Migrationsverkets beslut kan enligt 7 kap. [1 §](#kap7.1) överklagas till regeringen.
...
<section id="kap2.innehållet-i-ett-beslut-om-utv">
...
<section id="kap2.annan-verkan-av-ett-beslut-om">
...
<section id="kap2.muntlig-handläggning-hos-migra">
...
<section id="kap2.verkställande-myndighet">
...
<section id="kap2.hinder-mot-att-verkställa-utvi">
...
<section id="kap2.inhibition-och-tidsbegränsat-u">
...
<section id="kap2.förfarandet-när-ett-beslut-om">
...
I avvaktan på regeringens beslut enligt [18 §](#kap2.18) får det ansvariga statsrådet besluta om inhibition.
...
<section id="kap2.ny-verkställighet-av-ett-beslu">
...
<section id="kap2.särskilt-tillstånd-till-ett-ko">
...
<section id="kap2.upphävande-av-ett-återreseförb">
...
<section id="kap2.upphävande-av-ett-verkställt-b">
...
<section id="kap3.förutsättningar-för-att-ta-en">
...
<section id="kap3.vem-som-får-besluta-om-förvar">
...
<section id="kap3.interimistiska-beslut-om-förva">
...
<section id="kap3.förvarstidens-längd">
...
<section id="kap3.ny-prövning-av-ett-beslut-om-f">
...
<section id="kap3.skyldighet-att-ompröva-ett-bes">
...
<section id="kap3.skyldighet-att-upphäva-ett-bes">
...
<section id="kap3.muntlig-handläggning-vid-förva">
...
Detta gäller inte interimistiska beslut enligt 5 eller [6 §](#kap3.6) eller om regeringen är behörig myndighet.
...
<section id="kap3.verkställighet-av-ett-beslut-o">
...
<section id="kap3.ett-beslut-om-förvar-upphör-ef">
...
<section id="kap4.förutsättningar-för-att-ställa">
...
<section id="kap4.vad-ett-beslut-om-uppsikt-inne">
...
<section id="kap4.vem-som-får-besluta-om-uppsikt">
...
<section id="kap4.interimistiska-beslut-om-uppsi">
...
<section id="kap4.innehållet-i-ett-beslut-om-upp">
...
<section id="kap4.ny-prövning-av-ett-beslut-om-u">
...
<section id="kap4.ändring-av-ett-beslut-om-uppsi">
...
<section id="kap4.skyldighet-att-ompröva-ett-bes">
...
<section id="kap4.skyldighet-att-upphäva-ett-bes">
...
<section id="kap4.muntlig-handläggning-vid-uppsi">
...
<section id="kap4.ett-beslut-om-uppsikt-upphör-e">
...
<section id="kap5.användning-av-tvångsmedel">
...
<section id="kap5.anmälningsskyldighet-och-förbu">
...
Husrannsakan, genomsökning på distans, kroppsvisitation, kroppsbesiktning och upptagning av fingeravtryck och andra underlag
...
<section id="kap5.tillfälligt-omhändertagande-av">
...
<section id="kap5.hemlig-avlyssning-eller-hemlig">
...
<section id="kap5.hemlig-kameraövervakning">
...
<section id="kap5.vem-som-får-ansöka-och-besluta">
...
Beslut om husrannsakan, genomsökning på distans, kroppsvisitation, kroppsbesiktning och upptagning av fingeravtryck och andra underlag
...
Säkerhetspolisen får efter ett godkännande enligt [8 §](#kap5.8) andra stycket 1, [9 §](#kap5.9) första stycket 1 eller [16 §](#kap5.16) tredje stycket besluta om husrannsakan, genomsökning på distans, kroppsvisitation, kroppsbesiktning eller upptagning av fingeravtryck, fotografi eller video. Ett beslut om sådant tvångsmedel får meddelas om förutsättningarna i [3 §](#kap5.3) är uppfyllda. Lag ([2025:140](https://selex.se/eli/sfs/2025/140)).

</section>

</section>
<section id="kap5.beslut-om-ett-tillstånd-till-h">
...
<section id="kap5.beslutens-giltighetstid">
...
<section id="kap5.innehållet-i-ett-beslut-om-anm">
...
<section id="kap5.interimistiska-beslut-om-anmäl">
...
<section id="kap5.innehållet-i-ett-tillstånd-til">
...
<section id="kap5.fortsatt-användning-av-tvångsm">
...
<section id="kap5.ändring-eller-upphävande-av-et">
...
<section id="kap5.granskning-och-förstöring">
...
<section id="kap5.användning-av-överskottsinform">
...
<section id="kap5.skyldighet-att-upphäva-ett-bes">
...
<section id="kap5.pass-eller-andra-identitetshan">
...
<section id="kap5.migrationsverkets-upptagning-a">
...
<section id="kap5.omhändertagande-av-en-utlännin">
...
<section id="kap5.andra-åtgärder-för-att-underlä">
...
<section id="kap6.muntlig-handläggning-hos-en-fö">
...
<section id="kap6.muntlig-förhandling-i-migratio">
...
<section id="kap6.offentligt-biträde">
...
<section id="kap6.dokumentation-och-motivering-a">
...
<section id="kap6.kostnadsansvar">
...
<section id="kap6.bestämmelser-i-utlänningslagen">
...
2. 13 kap. [10 a §](#kap13.10a) om tolkning och översättning,

3. 13 kap. [11 §](#kap13.11) om tolkersättning,

4. 13 kap. [11 a §](#kap13.11a) om ombud och biträden,

5. 13 kap. [12 §](#kap13.12) om rättelse av beslut på grund av oriktig uppgift, och

6. 13 kap. 15 och [16 §](#kap6.16)§ om dna-analys. Lag ([2025:1294](https://selex.se/eli/sfs/2025/1294)).
...
<section id="kap7.beslut-om-utvisning-uppehållst">
...
<section id="kap7.beslut-om-inhibition-tidsbegrä">
...
<section id="kap7.beslut-om-förvar-eller-uppsikt">
...
<section id="kap7.beslut-om-biträde-ersättning-o">
...
<section id="kap7.migrationsöverdomstolens-beslu">
...
<section id="kap7.övriga-beslut-får-inte-överkla">
...
<section id="kap7.säkerhetspolisens-rätt-att-öve">
...
<section id="kap7.parter-vid-ett-överklagande">
...
<section id="kap7.förfarandet-vid-migrationsöver">
...
<section id="kap7.handläggning-enligt-utlännings">
...
<section id="kap7.överlämnande-av-vissa-ärenden">
...
<section id="kap7.nöjdförklaring">
...
<section id="kap8.straff-och-åtalsprövning">
...
<section id="kap8.åtalsmedgivande">
...
[2022:700](https://selex.se/eli/sfs/2022/700)

1. Denna lag träder i kraft den 1 juli 2022.

2. Genom lagen upphävs lagen ([1991:572](https://selex.se/eli/sfs/1991/572)) om särskild utlänningskontroll.

3. Om ett beslut om förvar har meddelats och verkställts före ikraftträdandet, ska den första nya prövningen enligt 3 kap. [10 §](#kap3.10) som görs därefter göras senast vid den tidpunkt då en ny prövning skulle ha gjorts enligt äldre bestämmelser.

4. Bestämmelsen i 1 kap. [3 §](#kap1.3) tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt

a) [1 §](#kap8.1) och [2 §](#kap8.2) första stycket den upphävda lagen,

b) [3 §](#kap8.3) lagen ([1989:530](https://selex.se/eli/sfs/1989/530)) om åtgärder för att förebygga våldsdåd med internationell bakgrund,

c) [47 §](#kap8.47) utlänningslagen ([1980:376](https://selex.se/eli/sfs/1980/376)),

d) [3 §](#kap8.3) lagen ([1973:162](https://selex.se/eli/sfs/1973/162)) om särskilda åtgärder till förebyggande av vissa våldsdåd med internationell bakgrund, eller

e) [29 §](#kap8.29) första stycket 5 och [30 §](#kap8.30) andra stycket utlänningslagen ([1954:193](https://selex.se/eli/sfs/1954/193)).

5. Bestämmelsen i 2 kap. [8 §](#kap2.8) tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
...
6. Bestämmelsen i 2 kap. [14 §](#kap2.14) tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
...
7. Bestämmelsen i 2 kap. [25 §](#kap2.25) första stycket tillämpas även vid ett beslut om återreseförbud som har meddelats före ikraftträdandet enligt

a) [2 §](#kap8.2) första stycket och [4 §](#kap8.4) den upphävda lagen,

b) [3 §](#kap8.3) andra stycket och [4 §](#kap8.4) lagen ([1989:530](https://selex.se/eli/sfs/1989/530)) om åtgärder för att förebygga våldsdåd med internationell bakgrund,

c) [47 §](#kap8.47) andra stycket och [49 §](#kap8.49) utlänningslagen ([1980:376](https://selex.se/eli/sfs/1980/376)), eller

d) [34 §](#kap8.34) första stycket utlänningslagen ([1954:193](https://selex.se/eli/sfs/1954/193)).

8. Bestämmelsen i 2 kap. [26 §](#kap2.26) tillämpas även vid ett beslut om återreseförbud som har meddelats före ikraftträdandet enligt
...
9. Bestämmelsen i 2 kap. [27 §](#kap2.27) tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
...
10. Bestämmelsen i 3 kap. [1 §](#kap3.1) första stycket 2 tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
...
11. Bestämmelsen i 3 kap. [2 §](#kap3.2) första stycket 2 tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
...
12. Bestämmelsen i 5 kap. [1 §](#kap5.1) första stycket tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
...
13. Bestämmelsen i 8 kap. [1 §](#kap8.1) första stycket tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
...
14. Bestämmelsen i 8 kap. [2 §](#kap8.2) första stycket tillämpas även vid ett beslut om återreseförbud som har meddelats före ikraftträdandet enligt
...
15. Bestämmelsen i 8 kap. [3 §](#kap8.3) tillämpas även vid ett beslut om anmälningsplikt som har meddelats före ikraftträdandet enligt 11, 11 a eller [14 §](#kap8.14) den upphävda lagen.

16. Bestämmelsen i 8 kap. [4 §](#kap8.4) tillämpas även vid ett beslut om utvisning som har meddelats före ikraftträdandet enligt
