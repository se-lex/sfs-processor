...
forarbeten: - "PROP 2009/10:164"
  - "BET 2009/10:MJU26"
  - "RSKR 2009/10:299"
pdf_url: https://rkrattsdb.gov.se/SFSdoc/10/100598.pdf
andringsforfattningar:
  - beteckning: "2011:1065"
    rubrik: Lag om ändring i lagen om hållbarhetskriterier för biodrivmedel och flytande biobränslen
  ...
  - beteckning: "2022:170"
    rubrik: Lag om ändring i lagen om hållbarhetskriterier för biodrivmedel och biobränslen
  ...
  - beteckning: "2025:572"
    rubrik: Lag om ändring i lagen om hållbarhetskriterier för vissa bränslen
  ...
  - beteckning: "2025:573"
    ...
    anteckningar: "ändr. 2 kap. 2, 3 §§"
---
<article selex:utfardad_datum="2010-06-10" selex:ikraft_datum="2010-08-01">
...
<section id="kap1.2b" class="paragraf">
...
<section id="kap1.krav-på-att-hållbarhetskriteri">
...
<section id="kap2.minskade-utsläpp-av-växthusgas">
...
<section id="kap2.2" class="paragraf" selex:status="upphord" selex:upphor_datum="2030-01-01">
...
b) har tagits i drift efter den 20 november 2023. Lag ([2025:572](https://selex.se/eli/sfs/2025/572)).

</section>
<section id="kap2.2" class="paragraf" selex:status="ikraft" selex:ikraft_datum="2030-01-01">

#### 2 §

För att fasta biobränslen ska anses som hållbara vid produktion av el, värme eller kyla ska användningen av dem medföra att utsläppen av växthusgaser understiger de utsläpp som användningen av fossila bränslen hade gett med minst 80 procent, om anläggningen där biobränslet används
...
2. har tagits i drift efter den 20 november 2023. Lag ([2025:573](https://selex.se/eli/sfs/2025/573)).

</section>
<section id="kap2.3" class="paragraf" selex:status="upphord" selex:upphor_datum="2030-01-01">
...
c) har tagits i drift efter den 20 november 2023. Lag ([2025:572](https://selex.se/eli/sfs/2025/572)).

</section>
<section id="kap2.3" class="paragraf" selex:status="ikraft" selex:ikraft_datum="2030-01-01">
...
d) har tagits i drift efter den 20 november 2023. Lag ([2025:573](https://selex.se/eli/sfs/2025/573)).
...
En anläggning anses ha tagits i drift enligt 2-[4 §](#kap2.4)§ så snart det vid anläggningen förekommer fysisk produktion av biodrivmedel, flytande biobränslen eller el, värme eller kyla från fasta eller gasformiga biobränslen. Lag ([2025:571](https://selex.se/eli/sfs/2025/571)).
...
Om biodrivmedel eller biobränslen har framställts av avfall eller rest-produkter, gäller markkriterierna i 8-[14 §](#kap2.14)§ i den utsträckning som anges i andra stycket.

</section>

</section>
<section id="kap2.för-biodrivmedel-eller-biobrän">

### För biodrivmedel eller biobränslen som har framställts av

- restprodukter från skogsbruk gäller kriterierna i 12 och [13 §](#kap2.13)§,

- restprodukter från vattenbruk eller fiske gäller kriterierna i 8-[11 §](#kap2.11)§,

- restprodukter från jordbruk gäller kriterierna i 8-11 och [14 §](#kap2.14)§, och

- avfall från jordbruk gäller kriteriet i [14 §](#kap2.14). Lag ([2025:571](https://selex.se/eli/sfs/2025/571)).
...
Första stycket 2 gäller dock inte om kronslutenheten täcker 10-30 procent av ytan och ändrad markanvändning inom området medför att kraven i [4 §](#kap2.4) uppfylls. Lag ([2025:571](https://selex.se/eli/sfs/2025/571)).
...
7. skogsbiomassan inte kommer från ett sådant område som avses i [8 §](#kap2.8), [10 §](#kap2.10) första stycket 1 eller [11 §](#kap2.11).
...
2. skogsbiomassan inte kommer från ett sådant område som avses i [8 §](#kap2.8), [10 §](#kap2.10) första stycket 1 eller [11 §](#kap2.11). Lag ([2025:571](https://selex.se/eli/sfs/2025/571)).
...
1. kriterier och geografisk räckvidd i fråga om de områden som anges i 8-[11 §](#kap2.11)§, och

2. hur det ska visas att villkoren i 12-[14 §](#kap2.14)§ är uppfyllda. Lag ([2025:571](https://selex.se/eli/sfs/2025/571)).
...
<section id="kap3.rapporteringsskyldighet">
...
Regeringen eller den myndighet som regeringen bestämmer får meddela föreskrifter om undantag från rapporteringsskyldigheten enligt första stycket. Lag ([2025:571](https://selex.se/eli/sfs/2025/571)).

</section>

</section>
<section id="kap3.kontrollsystem-och-hållbarhets">
...
<section id="kap3.1b" class="paragraf">
...
<section id="kap3.1c" class="paragraf">
...
<section id="kap3.återkallelse-av-hållbarhetsbes">

### Återkallelse av hållbarhetsbesked

<section id="kap3.1d" class="paragraf">
...
<section id="kap3.1e" class="paragraf">
...
<section id="kap3.1f" class="paragraf">
...
<section id="kap3a.2a" class="paragraf">
